...
@include('pages.common.header')
	...
	<section class="team-page-section">
		<div class="auto-container">
			...
			<div class="sec-title centered">
				<h2 style="color: #000;" >Teachers of   <span style="color: red;">the Week</span></h2>
			</div>
	...
	<section class="team-page-section">
		<div class="auto-container">
			<!-- Sec Title -->
			<div class="sec-title centered">
				<h2 style="color: #000;" >Teachers of   <span style="color: red;">the Month</span></h2>
			</div>
	...
	<section class="team-page-section">
		<div class="auto-container">
			<!-- Sec Title -->
			<div class="sec-title centered">
				<h2 style="color: #000;" >Teachers of   <span style="color: red;">the Year</span></h2>
			</div>
