	...
	<section class="case-section-three">
		<div class="auto-container">
			...
			<div class="row clearfix">
				...
				<!-- Case Block -->
				<?php if (count($biologylab_facilities) > 0): ?>
				<?php foreach ($biologylab_facilities as $biologylab_facilitie): $images = $biologylab_facilitie['images']; ?>
				...
				<div class="case-block-two col-lg-4 col-md-6 col-sm-12">
					...
					<div class="inner-box wow pulse" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="image-outer">
							<div class="image">
								<img src="<?php echo HOME. $biologylab_facilitie['images']; ?>" alt="" />
								<div class="overlay-box">
									<a href="<?php echo HOME. $biologylab_facilitie['images']; ?>" data-fancybox="news" data-caption="" class="plus flaticon-plus-symbol"></a>
								</div>
							</div>
						</div>
						<div class="lower-content">
							<div class="category"><h5>Biology Laboratory</h5></div>
							<p><?php echo $biologylab_facilitie['description']; ?></p></div>
						</div>
					</div>
			...
			<?php endif; ?>
				...
				<a href="<?php echo HOME; ?>chemistrylab" class="theme-btn btn-style-fourteen">View Facilities</a>
			</div>
			</div>	
		</div>
	</section>
