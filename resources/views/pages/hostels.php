	...
	<section class="case-section-three">
		<div class="auto-container">
			...
			<div class="row clearfix">
				...
				<!-- Case Block -->
				<?php if (count($hostels_facilities) > 0): ?>
				<?php foreach ($hostels_facilities as $hostels_facilitie): $images = $hostels_facilitie['images']; ?>
				...
				<div class="case-block-two col-lg-4 col-md-6 col-sm-12">
					...
					<div class="inner-box wow pulse" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="image-outer">
							<div class="image">
								<img style="width: 100%; height: 200px;"  src="<?php echo HOME. $hostels_facilitie['images']; ?>" alt="" />
								<div class="overlay-box">
									<a href="<?php echo HOME. $hostels_facilitie['images']; ?>" data-fancybox="news" data-caption="" class="plus flaticon-plus-symbol"></a>
								</div>
							</div>
						</div>
						<div class="lower-content">
							<div class="category"><h5>Hostels Facilities</h5></div>
							<p><?php echo $hostels_facilitie['description']; ?></p></div>
						</div>
					</div>
