	...
	<section class="case-section-three">
		<div class="auto-container">
			...
			<div class="row clearfix">
				...
				<!-- Case Block -->
				<?php if (count($physicslab_facilities) > 0): ?>
				<?php foreach ($physicslab_facilities as $physicslab_facilitie): $images = $physicslab_facilitie['images']; ?>
				...
				<div class="case-block-two col-lg-4 col-md-6 col-sm-12">
					...
					<div class="inner-box wow pulse" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="image-outer">
							<div class="image">
								<img src="<?php echo HOME. $physicslab_facilitie['images']; ?>" alt="" />
								<div class="overlay-box">
									<a href="<?php echo HOME. $physicslab_facilitie['images']; ?>" data-fancybox="news" data-caption="" class="plus flaticon-plus-symbol"></a>
								</div>
							</div>
						</div>
						<div class="lower-content">
							<div class="category"><h5>Physics Laboratory</h5></div>
							<p><?php echo $physicslab_facilitie['description']; ?></p></div>
						</div>
					</div>
			...
			<?php endif; ?>
				...
				<a href="<?php echo HOME; ?>biologylab" class="theme-btn btn-style-fourteen">View Facilities</a>
			</div>
			</div>	
		</div>
	</section>
