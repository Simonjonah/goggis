...
@foreach ($secondterm_results as $secondterm_result)
  @if ($secondterm_result->status == 'approved')
      @php
      $total_score2 +=$secondterm_result->test_1 + $secondterm_result->test_2 + $secondterm_result->exams;
  @endphp
  @endif
@endforeach
...
<table class="table">
    ...
    <table>
        <tr>
          ...
          <th>Exams</th>
          <th>Term Total</th>
          <th>3 <sup>3rd</sup>Term <br>Total</th>
    ...
    <td>-</td>
        ...
        <td style="width: 80px;">{{ $total_score2 }}</td>
        ...
        <td style="width: 80px;">{{ $total_scoreforliteracy / $totalstudentInClass }}</td>
    ...
    <td>-</td>
        ...
        <td style="width: 80px;">{{ $total_scorefornumeracy / $totalstudentInClass }}</td>
    ...
    <td>-</td>
        ...
        <td style="width: 80px;">{{ $total_fornone / $totalstudentInClass }}</td>
    ...
    <td>-</td>
        ...
        <td style="width: 80px; font-weight: bold;">{{ $total_forcca / $totalstudentInClass }}</td>
