@include('dashboard.header')
  ...
  <div class="content-wrapper">
    ...
    @if (Auth::guard('web')->user()->promotion == 'Center Head' && Auth::guard('web')->user()->centername == 'Uyo')
                  ...
                  <tbody>
                    ...
                    @endif
                      ...
                      @foreach ($view_classstudents as $view_classstudent)
                        @if ($view_classstudent->centername == 'Uyo')
                        <tr>
                      ...
                      <ul class="dropdown-menu">
                        ...
                        <td>{{ $view_classstudent->ref_no }}</td>
                          <td><a href="{{ url('web/editstudenthead/'.$view_classstudent->ref_no) }}"
                            class='btn btn-info'>
                        ...
                        <th> <a href="{{ url('web/studentsaddmithead/'.$view_classstudent->ref_no) }}" class="btn btn-sm btn-primary">
                          <i class="fas fa-user"></i> 
                        </a></th>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @if (Auth::guard('web')->user()->promotion == 'Center Head' && Auth::guard('web')->user()->centername == 'Uyo')
                    @foreach ($view_classstudents as $view_classstudent)
                    @if ($view_classstudent->section == 'High School' && $view_classstudent->centername == 'Uyo')
                      <tr>
                        <td>{{ $view_classstudent->classname }}</td>
                        <td>{{ $view_classstudent->middlename }}</td>
                        <td>{{ $view_classstudent->fname }}</td>
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    @endif
                      ...
                      @foreach ($view_classstudents as $view_classstudent)
                        @if ($view_classstudent->centername == 'Abuja' || $view_classstudent->section == 'Pre-School' || $view_classstudent->section == 'Nursery' || $view_classstudent->section == 'Primary' || $view_classstudent->section == 'Elementary')
                        <tr>
                          <td>{{ $view_classstudent->classname }}</td>
                          <td>{{ $view_classstudent->middlename }}</td>
                          <td>{{ $view_classstudent->fname }}</td>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @if (Auth::guard('web')->user()->promotion == 'Center Head')
                    @foreach ($view_classstudents as $view_classstudent)
                    @if ($view_classstudent->section == 'High School' && $view_classstudent->centername == 'Abuja')
                      <tr>
                        <td>{{ $view_classstudent->classname }}</td>
                        <td>{{ $view_classstudent->middlename }}</td>
                        <td>{{ $view_classstudent->fname }}</td>
