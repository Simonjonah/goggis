                  ...
                  <tbody>
                    ...
                    @foreach ($reject_students as $reject_student)
                      ...
                      <tr>
                       ...
                       <th><a href="{{ url('admin/rejectstudent1/'.$reject_student->ref_no1) }}" class="btn btn-sm bg-teal">
                        <i class="fas fa-user"></i>
                      </a></th>

                      </a></th><th><a href="{{ url('admin/suspendstudent1/'.$reject_student->ref_no1) }}" class="btn btn-sm bg-teal">
                        <i class="fas fa-comments"></i>
                      </a></th>

                      <th> <a href="{{ url('admin/studentsaddmit1/'.$reject_student->ref_no1) }}" class="btn btn-sm btn-primary">
                        <i class="fas fa-user"></i> 
                      </a></th>
                      <th><a href="{{ url('admin/studentpdf1/'.$reject_student->ref_no1) }}" class="btn btn-success"><i class="fas fa-print"></i></a></th>
                       <td><a href="{{ url('admin/deletestudent1/'.$reject_student->ref_no1) }}"
