                  ...
                  <tbody>
                    ...
                    @foreach ($all_students as $all_student)
                      ...
                      <tr>
                        ...
                        <td>{{ $all_student->middlename }} {{ $all_student->classname }}</td>
                        <td>{{ $all_student->fname }} {{ $all_student->assign1 }}</td>
                        <td><img style="width: 100%; height: 60px;" src="{{ URL::asset("/public/../$all_student->images")}}" alt=""></td>
                        <td><a href="{{ url('admin/viewstudents/'.$all_student->ref_no1) }}"
                      ...
                      <td>{{ $all_student->ref_no1 }}</td>

                         <td><a href="{{ url('admin/editstudent/'.$all_student->ref_no1) }}"
                          class='btn btn-info'>
                      ...
                      {{-- <th><a href="{{ url('admin/studentit/'.$all_student->ref_no1) }}" class="btn btn-info"><i class="fas fa-user"></i> IT</a></th> --}}
                       <td><a href="{{ url('admin/deletestudent/'.$all_student->ref_no1) }}"
