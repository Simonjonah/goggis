        ...
        <div class="row">
            <div class="col-12">
              ...
              <h2 class="page-header text-center">
                 ...
                 61 Ntiedo Street, off Udo umana, Uyo
                  Akwa Ibom, Nigeria
              ...
              <div class="card-body">
                <form class="form-horizontal" action="{{ url('admin/settingsupdate/'.$view_singteachers->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{ $view_singteachers->fatheraddress }}" name="phone" id="inputName2" placeholder="Address">
                      </div>
                    </div>
