        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ url('admin/updatesclubform/'.$edit_club->id) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input required type="text" value="{{ $edit_club->tname }}" class="form-control" name="tname" placeholder="First Name">
                        </div>
                      </div>
                      @error('tname')
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input required type="text" value="{{ $edit_club->tlastname }}" class="form-control" name="tlastname" placeholder="First Name">
                        </div>
                      </div>
                      @error('tlastname')
                      <span class="text-danger">{{ $message }}</span>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input required type="text" value="{{ $edit_club->fname }}" class="form-control" name="fname" placeholder="First Name">
                        </div>
                      </div>
                      @error('fname')
                      <span class="text-danger">{{ $message }}</span>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" value="{{ $edit_club->middlename }}" class="form-control" name="middlename" placeholder="First Name">
                        </div>
                      </div>
                      @error('middlename')
                      <span class="text-danger">{{ $message }}</span>
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label> Age</label>
                          <input required type="text" value="{{ $edit_club->age }}" class="form-control" name="age" placeholder="Age">
                        </div>
                      </div>
                      @error('age')
                      <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label> Gender {{ $edit_club->gender }}</label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <select name="centername" class="form-control" id="">
                              ...
                              <option value="{{ $edit_club->centername }}">{{ $edit_club->centername }}</option>
