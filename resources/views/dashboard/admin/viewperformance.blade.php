                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror value="{{ $view_weeks->fname }}" name="fname" placeholder=" First Name">
                      </div>
                    </div>
                    @error('fname')
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror value="{{ $view_weeks->lname }}" name="lname" placeholder=" Last Name">
                      </div>
                    </div>
                    @error('lname')
                    <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        @enderror value="{{ $view_weeks->designation }}" name="designation" placeholder="Designation">
                      </div>
                    </div>
                    @error('designation')
                    <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select name="dayac" class="form-control">
                            <option value="">{{ $view_weeks->daysac }}</option>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select name="monthsac" class="form-control">
                          <option value="">{{ $view_weeks->monthsac }}</option>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select name="yrsac" class="form-control">
                            <option value="{{ $view_weeks->yrsac }}">{{ $view_weeks->yrsac }}</option>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select name="role" class="form-control">
                          <option value="">{{ $view_weeks->yrsac }}</option>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>  Image</label>
                        <td><img style="width: 100px; height: 60px;" src="{{ URL::asset("/public/../$view_weeks->images")}}" alt=""></td>
                    ...
                    <div class="col-sm-6">
                      ...
                      value="{{ old('messages') }}"     style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $view_weeks->messages }}</textarea>
                     </div>
                      @error('messages')
                      <span class="text-danger">{{ $message }}</span>
                      @enderror
