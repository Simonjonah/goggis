        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ url('admin/teacherofmonth') }}" class="btn btn-primary">Teachers of the Month</a></li>
              <li class="breadcrumb-item"><a href="{{ url('admin/teacherofyear') }}" class="btn btn-success">Teachers of the Year</a></li>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @foreach ($view_puoftheweeks as $view_puoftheweek)
                      @if ($view_puoftheweek->role == 'Teacher of the Month')
                      <tr>
