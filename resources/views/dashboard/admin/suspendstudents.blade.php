                  ...
                  <tbody>
                    ...
                    @foreach ($suspend_students as $suspend_student)
                      ...
                      <tr>
                       ...
                       <th><a href="{{ url('admin/rejectstudent1/'.$suspend_student->ref_no1) }}" class="btn btn-sm bg-teal">
                        <i class="fas fa-user"></i>
                      </a></th>
                      
                      </a></th><th><a href="{{ url('admin/suspendstudent1/'.$suspend_student->ref_no1) }}" class="btn btn-sm bg-teal">
                        <i class="fas fa-comments"></i>
                      </a></th>

                      <th> <a href="{{ url('admin/studentsaddmit1/'.$suspend_student->ref_no1) }}" class="btn btn-sm btn-primary">
                        <i class="fas fa-user"></i> 
                      </a></th>
                      <th><a href="{{ url('admin/studentpdf1/'.$suspend_student->ref_no1) }}" class="btn btn-success"><i class="fas fa-print"></i></a></th>
                       <td><a href="{{ url('admin/deletestudent1/'.$suspend_student->ref_no1) }}"
