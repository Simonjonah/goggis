          ...
          <div class="card-body">
            <div class="row">
              <div class="col-12 col-sm-6">
                ...
                <div class="form-group">
                  <p>Classname</p>
                  <input type="text" class="form-control" value="{{ Auth::guard('admin')->user()->classname }}" name="classname" id="" placeholder="Classname">
                </div>
              ...
              <div class="form-group">
                ...
                <div class="form-group">
									...
									<select name="term" class="form-control"  id="">
										<option value="{{ Auth::guard('admin')->user()->entrylevel }}">{{ Auth::guard('admin')->user()->entrylevel }}</option>
