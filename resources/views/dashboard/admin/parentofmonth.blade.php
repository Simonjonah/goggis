        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ url('admin/parentofmonth') }}" class="btn btn-primary">Parents of the Month</a></li>
              <li class="breadcrumb-item"><a href="{{ url('admin/parentofyear') }}" class="btn btn-success">Parents of the Year</a></li>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    @foreach ($view_puoftheweeks as $view_puoftheweek)
                      @if ($view_puoftheweek->role == 'Parent of the Month')
                      <tr>
