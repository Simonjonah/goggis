                    ...
                    <div class="form-group">
                      ...
                      <select required class="form-control" type="text" name="user_id">
                        @if ($assigned_subject->section == 'Primary')
                          ...
                          @elseif ($assigned_subject->section == 'Pre-School')
                          @foreach ($assigned_preschool_subjects as $assigned_preschool_subject)
                            <option value="{{ $assigned_preschool_subject->id }}">{{ $assigned_preschool_subject->fname }} {{ $assigned_preschool_subject->surname }} {{ $assigned_preschool_subject->centername }} {{ $assigned_preschool_subject->section }} {{ $assigned_preschool_subject->classname }}</option>
                          @endforeach
                        @else
