                        ...
                        <table class="table table-striped">
                            ...
                            @foreach ($view_teachersubjects as $view_teachersubject)
                              ...
                              <tr>
                                ...
                                {{-- <input type="hidden" name="teacher_id[]" value="{{ $view_studentsubject->id }}" placeholder="Teacher ID"> --}}
                                  ...
                                  {{-- <input type="hidden" value="{{ $view_studentsubject->fname }}" name="tname[]" id=""></td> --}}
                                  {{-- <input type="hidden" value="{{ $view_studentsubject->surname }}" name="tsurname[]" id=""></td> --}}
                          ...
                          @foreach ($view_teachersubjects as $view_teachersubject)
                            ...
                            <tr>
                               ...
                               <input type="hidden" name="centername[]" value="{{ $view_studentsubject->centername }}" placeholder="ID">
                                ...
                                <input type="hidden" name="tname[]" value="{{ $view_studentsubject->fname }}" placeholder="Teacher ID">
                                <input type="hidden" name="tsurname[]" value="{{ $view_studentsubject->surname }}" placeholder="Teacher ID">
                                {{-- <input type="hidden" name="teacher_id[]" value="{{ $view_studentsubject->id }}" placeholder="Teacher ID"> --}}
                                <input type="hidden" name="user_id[]" value="{{ $view_studentsubject->id }}" placeholder="ID">
                                <input type="hidden" name="term[]" value="{{ $view_studentsubject->term }}" placeholder="term">
                                <input type="hidden" name="academic_session[]" value="{{ $view_studentsubject->academic_session }}" placeholder="academic_session">
                                ...
                                <input type="hidden" name="images[]" value="{{ $view_studentsubject->images }}" placeholder="Parent ID">
                                <input type="hidden" name="images[]" value="{{ $view_studentsubject->images }}" placeholder="Parent ID">
                               <input type="hidden" value="{{ $view_studentsubject->tname }}" name="tname[]" id=""></td> 
                                 <input type="hidden" value="{{ $view_studentsubject->tsurname }}" name="tsurname[]" id=""></td> 
                                 <input type="hidden" value="{{ $view_studentsubject->comment }}" name="comment[]" id=""></td> 
