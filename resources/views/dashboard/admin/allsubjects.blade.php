                  ...
                  @endif
                    ...
                    @foreach ($viewnursery_subjects as $viewnursery_subject)
                      ...
                      <tr>
                        ...
                        <td>{{ $viewnursery_subject->category }}</td>
                       
                        
                        
                        <td><a href="{{ url('admin/assignsubject/'.$viewnursery_subject->id) }}"
                          class='btn btn-primary'>
                           <i class="far fa-user"></i>
                       </a></td> 
                    
                         <td><a href="{{ url('admin/editsubject/'.$viewnursery_subject->id) }}"
                          class='btn btn-info'>
                       ...
                       <td><a href="{{ url('admin/deletesubject/'.$viewnursery_subject->id) }}"
