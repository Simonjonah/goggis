        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card card-secondary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form action="{{ url('admin/createimage4/'.$add_market->ref_no) }}" method="post" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <td><img style="width: 70%; height: 200px;" src="{{ URL::asset("/public/../$add_market->images4")}}" alt=""></td>
                        <label> Image</label>
