                  ...
                  <tbody>
                    ...
                    @foreach ($view_myresults as $view_myresult)
                      ...
                      <tr>
                        ...
                        <td>{{ $view_myresult->regnumber }} {{ $view_myresult->type }}
                        <small>
                     ...
                     <td><a href="{{ url('admin/editresultmidtermadmin/'.$view_myresult->id) }}"
                            class='btn btn-info'>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{ url('admin/searchforresultesmidterm') }}" method="post">
          @csrf
          <div class="form-group">
            <label for="">Select Center</label>
            <select name="centername" required class="form-control" id="">
              @foreach ($view_myresults as $view_studycenter)
