...
@foreach ($getyour_results as $getyour_result)
    @if ($getyour_result->status == 'approved' || $getyour_result->status == null && $getyour_result->category == 'MATHEMATICAL SKILL')
...
@endphp
    ...
    $total_score = 0; ?>
                                    ...
                                    @foreach ($getyour_results as $getyour_result)
                                      ...
                                      <tr>
                                          ...
                                          <td style="width: 45px; font-size: 16px;">
                                            ...
                                            <td style="width: 80px; font-size: 16px;">V.Poor</td>
                                          @endif</td>
                                          <td style="width: 45px; font-size: 16px;"><a  href="{{ url('web/removeresultbyteacher/'.$getyour_result->id) }}">Remove Results</a></td>
                  ...
                  <table>
                    ...
                    <tr>
                        <td style="font-size: 16px;">NO.cvv OF PUPILS IN CLASS: </td>
                        <td style="font-size: 16px;">{{ $totalstudentInClass }}</td>
                        <td style="font-size: 20px"><b>Position:</b> </td>
