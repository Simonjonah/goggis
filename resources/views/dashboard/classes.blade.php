                    ...
                    @if (Auth::guard('web')->user()->promotion = 'Center Head')
                        @foreach ($view_classes as $view_classe)
                            ...
                            <tr>
                                ...
                                <td>{{ $view_classe->entrylevel }}

                                <a class="btn btn-info" href="{{ url('web/addregnumber1/'.$view_classe->id) }}">Add Admission No</a>
                                ...
                                <td><a href="{{ url('web/editstudentbyparent/'.$view_classe->ref_no1) }}"
                                    class='btn btn-info'>
                                ...
                                <th> <a href="{{ url('web/studentsaddmithead/'.$view_classe->ref_no) }}" class="btn btn-sm btn-primary">
                                <i class="fas fa-user"></i> 
                                </a></th>
