              ...
              <div class="row">
                ...
                <div class="col-12 table-responsive">
                  ...
                  <table class="table table-striped">
                      ...
                      <tbody>
                          @foreach ($view_myresult_results as $view_myresult_result)
                            @if ($view_myresult_result->category == 'LITERACY')
                            @php
                            ...
                            <tr>
                              ...
                              <td>{{ $view_myresult_result->test_1  + $view_myresult_result->test_2  + $view_myresult_result->test_3  }}</td>
                             ...
                             @elseif ($view_myresult_result->category == 'NUMERACY')
                             <tr>
                           ...
                           @elseif ($view_myresult_result->category == 'CCA')
                           <tr>
                            ...
                            @elseif ($view_myresult_result->category == 'None')
                            <tr>
