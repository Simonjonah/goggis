                    ...
                    @foreach ($view_midtermmyresults as $view_midtermmyresult)
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            Approved
                             <i class="far fa-eye"></i></a></td>
                          <td>{{ $view_midtermmyresult->exp }}</td>
                          <td>{{ $view_midtermmyresult->app }}</td>
                          <td>{{ $view_midtermmyresult->pra }}</td>
                          <td>{{ $view_midtermmyresult->type }}</td>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Check midterm Result of A Child</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <form action="{{ url('web/midtermbreakcheckmidtermresultbyheads') }}" method="post">
            @csrf
