              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  {{-- @if (Auth::guard('web')->user()->promotion == 'High School') --}}
                    ...
                    @if ($view_highstudent->centername == Auth::guard('web')->user()->centername && $view_highstudent->role == null)
                      <tr>
                      ...
                      <td>{{ $view_highstudent->ref_no }}</td>
                        <td><a href="{{ url('admin/editstudenthead/'.$view_highstudent->ref_no) }}"
                          class='btn btn-info'>
                      ...
                      <th> <a href="{{ url('web/studentsaddmithead/'.$view_highstudent->ref_no) }}" class="btn btn-sm btn-primary">
                        <i class="fas fa-user"></i> 
                      </a></th>
