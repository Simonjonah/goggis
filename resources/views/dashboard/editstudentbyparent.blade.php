...
<section class="content">
    ...
    <div class="form-group">
      ...
      @enderror value="{{ $edit_student->middlename }}" id="exampleInputEmail1" placeholder="Middlename">
    </div>
    @error('middlename')
    ...
    <div class="form-group">
      ...
      @enderror value="{{ $edit_student->lga }}" id="exampleInputEmail1" placeholder="Place of Birth">
    </div>
    @error('lga')
    <span class="text-danger">{{ $message }}</span>
    @enderror
    ...
    <div class="form-group">
      ...
      @enderror value="{{ $edit_student->religion }}" id="exampleInputEmail1" placeholder="Religion">
    </div>
    @error('religion')
    <span class="text-danger">{{ $message }}</span>
    @enderror
    ...
    <div class="form-group">
      ...
      <select name="term" class="form-control"  id="">
        <option value="{{ $edit_student->term }}">{{ $edit_student->term }}</option>
  ...
  <div class="form-group">
      ...
      @enderror value="{{ $edit_student->state }}" id="exampleInputEmail1" placeholder="State of Origin">
    </div>
    @error('state')
    <span class="text-danger">{{ $message }}</span>
    @enderror
...
<div class="form-group">
  ...
  <select id="staybeyond" name="att" class="form-control">
    <option value="{{ $edit_student->att }}">{{ $edit_student->att }}</option>
...
<textarea class="form-control" id="info" name="attendedtime" value="{{ $edit_student->staybeyondtime }}" cols="30" placeholder="Why..."></textarea>
<br>
...
<div class="form-group">
      ...
      Yes <input value="Yes" value="{{ $edit_student->medreports }}"  type="checkbox" name="medreports"> 
      No  <input value="No" value="{{ $edit_student->medreports1 }}" type="checkbox" name="medreports1">
    </div>

    <div class="form-group">
      <h5>Who is your Child living with?</h5>
      <input value="{{ $edit_student->livingwith }}" class="form-control"  type="text" name="livingwith"> 
    </div>

    <div class="form-group">
      <h5>Any Other Vital Information should be provided below?</h5>
      <textarea value="" row="10" cols="10" class="form-control" name="livingwith1" placeholder="Write here"> {{ $edit_student->livingwith1 }}</textarea>
    </div>

    <div class="form-group">
      <img class="image rounded-circle" src="{{ asset('/public/../'.$edit_student->birthcert )}}" alt="profile_image" style="width: 80px;height: 80px; padding: 10px; margin: 0px; ">
...
<div class="form-group">
  <h5>Date of Birth</h5>
    ...
    @enderror value="{{ $edit_student->dob }}" id="exampleInputEmail1" placeholder="Date of Birth">
  </div>
  @error('dob')
  <span class="text-danger">{{ $message }}</span>
  @enderror
...
<div class="form-group">
  ...
  <select id="yesNo" name="started_school" class="form-control">
    <option value="{{ $edit_student->started_school }}">{{ $edit_student->started_school }}</option>
...
<input type="text" value="{{ $edit_student->school_name }}" class="form-control" id="info" name="school_name" placeholder="Name of School">
<br>
<label for="info">Class Admitted</label>
<input type="text" class="form-control" value="{{ $edit_student->class_attended }}" id="info" name="class_attended" placeholder="Class Admitted">
<label for="info">Evidence of Fee payment at last School Attended</label>
<img class="image rounded-circle" src="{{ asset('/public/../'.$edit_student->payment_evid )}}" alt="profile_image" style="width: 80px;height: 80px; padding: 10px; margin: 0px; ">
...
<img class="image rounded-circle" src="{{ asset('/public/../'.$edit_student->report_card )}}" alt="profile_image" style="width: 80px;height: 80px; padding: 10px; margin: 0px; ">
...
<div class="form-group">
  ...
  <select class="form-control" type="text" name="classname" required="">
    <option value="{{ $edit_student->classname }}">{{ $edit_student->classname }}</option>
...
<img class="image rounded-circle" src="{{ asset('/public/../'.$edit_student->images )}}" alt="profile_image" style="width: 80px;height: 80px; padding: 10px; margin: 0px; ">
  ...
  <div class="form-group">
      ...
      <select class="form-control" name="academic_session" id="">
        <option value="{{ $edit_student->academic_session }}">{{ $edit_student->academic_session }}</option>
  ...
  <select id="attend" name="tobeattended" class="form-control">
    <option value="{{ $edit_student->attend }}">{{ $edit_student->attend }}</option>
  ...
  <div id="addedthings" style="display: none;">
      ...
      <input type="text" class="form-control" value="{{ $edit_student->attended }}" id="info" name="attended" placeholder="Name of the Person">
    </div>
  </div>
  ...
  <div class="form-group">
    <h4>Which Game does your Child like best?</h4>
      <input value="{{ $edit_student->game }}" class="form-control" type="text" name="game" id="">
  </div>

  <div class="form-group">
    <h4>Mention types of Toys your child plays with?</h4>
      <input class="form-control" type="text" name="toys" value="{{ $edit_student->toys }}">
  </div>
  ...
  <div class="form-group">
    <h4>How many hours do you spend with your Child?</h4>
      <input class="form-control" type="text" name="spent" value="{{ $edit_student->spent }}">
  </div>
