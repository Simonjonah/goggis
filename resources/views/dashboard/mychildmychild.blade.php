                  ...
                  {{-- @if (Auth::guard('web')->user()->promotion == 'Pre-School Head') --}}
                    ...
                    @if ($view_mychild->centername == Auth::guard('web')->user()->centername && $view_mychild->role == null)
                      <tr>
                        ...
                        <td><a href="{{ url('web/viewstudents/'.$view_mychild->ref_no) }}"
                      ...
                      <td>{{ $view_mychild->ref_no }}</td>
                        <td><a href="{{ url('web/editstudenthead/'.$view_mychild->ref_no) }}"
                          class='btn btn-info'>
                      ...
                      <th> <a href="{{ url('web/studentsaddmithead/'.$view_mychild->ref_no) }}" class="btn btn-sm btn-primary">
                        <i class="fas fa-user"></i> 
                      </a></th>
                      ...
                      {{-- <th><a href="{{ url('web/studentit/'.$view_mychild->ref_no) }}" class="btn btn-info"><i class="fas fa-user"></i> IT</a></th> --}}
                      <td><a href="#"
