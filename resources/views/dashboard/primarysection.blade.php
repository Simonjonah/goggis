      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            @if ($view_classes->section == 'Primary')
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  {{-- @if (Auth::guard('web')->user()->section = 'Pre-School') --}}
                    ...
                    @if ($view_primarystudent->centername == Auth::guard('web')->user()->centername && $view_primarystudent->assign1 == 'student')
                      <tr>
                      ...
                      <td>{{ $view_primarystudent->ref_no1 }}</td>
                        <td><a href="{{ url('web/editstudent/'.$view_primarystudent->ref_no1) }}"
                          class='btn btn-info'>
                      ...
                      <th> <a href="{{ url('web/studentsaddmitew/'.$view_primarystudent->ref_no1) }}" class="btn btn-sm btn-primary">
