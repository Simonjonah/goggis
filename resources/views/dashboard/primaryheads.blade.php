              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @if (Auth::guard('web')->user()->promotion == 'Primary Head')
                    ...
                    @if ($view_primarystudent->centername == Auth::guard('web')->user()->centername && $view_primarystudent->section == Auth::guard('web')->user()->section )
                      <tr>
                        <td>{{ $view_primarystudent->classname }}</td>
                        <td>{{ $view_primarystudent->middlename }}</td>
                        <td>{{ $view_primarystudent->fname }}</td>
                        <td>{{ $view_primarystudent->entrylevel }}
                        <a class="btn btn-info" href="{{ url('web/addregnumber1/'.$view_primarystudent->id) }}">Add Admission No</a>
                        ...
                        <td><a href="{{ url('web/viewstudentsbyparent/'.$view_primarystudent->ref_no1) }}"
                      ...
                      <td>{{ $view_primarystudent->ref_no1 }}</td>
                        <td><a href="{{ url('web/editstudentbyparent/'.$view_primarystudent->ref_no1) }}"
                          class='btn btn-info'>
                      ...
                      <th> <a href="{{ url('web/studentsaddmit1ew/'.$view_primarystudent->ref_no1) }}" class="btn btn-sm btn-primary">
                        <i class="fas fa-user"></i> 
                      </a></th>
                      ...
                      {{-- <th><a href="{{ url('web/studentit/'.$view_primarystudent->ref_no1) }}" class="btn btn-info"><i class="fas fa-user"></i> IT</a></th> --}}
                      <td><a href="#"
