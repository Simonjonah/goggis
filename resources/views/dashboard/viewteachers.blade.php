                  ...
                  {{-- @if (Auth::guard('web')->user()->promotion == 'Primary Head') --}}
                    ...
                    @if ($view_primarystudent->centername == Auth::guard('web')->user()->centername && $view_primarystudent->status == null)
                      ...
                      <td>{{ $view_primarystudent->ref_no }}</td>
                        <td><a href="{{ url('web/editstudenthead/'.$view_primarystudent->ref_no) }}"
                          class='btn btn-info'>
                      ...
                      <th> <a href="{{ url('web/studentsaddmithead/'.$view_primarystudent->ref_no) }}" class="btn btn-sm btn-primary">
                        <i class="fas fa-user"></i> 
                      </a></th>
