              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  {{-- @if (Auth::guard('web')->user()->promotion == 'Pre-School Head') --}}
                    ...
                    @if ($view_preschoolstudent->centername == Auth::guard('web')->user()->centername && $view_preschoolstudent->role == null)
                      <tr>
                      ...
                      <td>{{ $view_preschoolstudent->ref_no }}</td>
                        <td><a href="{{ url('web/editstudenthead/'.$view_preschoolstudent->ref_no) }}"
                          class='btn btn-info'>
                      ...
                      <th> <a href="{{ url('web/studentsaddmithead/'.$view_preschoolstudent->ref_no) }}" class="btn btn-sm btn-primary">
                        <i class="fas fa-user"></i> 
                      </a></th>
