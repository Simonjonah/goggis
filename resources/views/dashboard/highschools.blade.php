              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  @if (Session::get('success'))
                    ...
                    {{ Session::get('fail') }}
                    @endif
                  @if (Auth::guard('web')->user()->promotion == 'High Head')
                    @foreach ($view_highstudents as $view_highstudent)
                    @if ($view_highstudent->centername == Auth::guard('web')->user()->centername )
                      <tr>
                        ...
                        <td><a href="{{ url('web/viewstudentsbyparent/'.$view_highstudent->ref_no1) }}"
                      ...
                      <td>{{ $view_highstudent->ref_no1 }}</td>
                        <td><a href="{{ url('web/editstudentbyparent/'.$view_highstudent->ref_no1) }}"
                          class='btn btn-info'>
                      ...
                      <th> <a href="{{ url('web/studentsaddmit1ew/'.$view_highstudent->ref_no1) }}" class="btn btn-sm btn-primary">
                        <i class="fas fa-user"></i> 
                      </a></th>
                      ...
                      {{-- <th><a href="{{ url('web/studentit/'.$view_highstudent->ref_no1) }}" class="btn btn-info"><i class="fas fa-user"></i> IT</a></th> --}}
                      <td><a href="#"
