          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                <div class="col-12">
                  <h4>
                    ...
                    <small class="float-right">Date: {{ $view_payment->created_at->format('D d, M Y, H:i') }}</small>
                  </h4>
                </div>
                <!-- /.col -->
              </div>
              ...
              <div class="row">
                <div class="col-12 table-responsive">
                  <table class="table table-striped">
                    ...
                    <tbody>
                    <tr>
                        <td>{{ $view_payment->fname }}</td>

                        <td>{{ $view_payment->middlename }}</td>
                        <td>{{ $view_payment->surname }}</td>
                        <td>{{ $view_payment->regnumber }}</td>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      <tr>
                        ...
                        <td>	{{ $view_payment->classname}}</td>
                      </tr>
                      <tr>
                        <th>Term</th>
                        <td>{{ $view_payment->payment['entrylevel'] }}</td>
                      </tr>
                      {{-- <tr>
                        <th>Semester</th>
              ...
              <!-- <div class="row no-print">
                <div class="col-12">
                  <a href="{{ url('web/paymentspdf1/'.$view_payment->id) }}"  class="btn btn-default"><i class="fas fa-print"></i> Print</a>
